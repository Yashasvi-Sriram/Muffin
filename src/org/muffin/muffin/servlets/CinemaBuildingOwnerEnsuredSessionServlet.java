...
public class CinemaBuildingOwnerEnsuredSessionServlet extends EnsuredSessionServlet {

    @Override
    protected boolean ensureSession(HttpServletRequest request, HttpServletResponse response) throws IOException {
        HttpSession session = request.getSession(false);
        if (session == null || session.getAttribute(SessionKeys.CINEMA_BUILDING_OWNER) == null) {
