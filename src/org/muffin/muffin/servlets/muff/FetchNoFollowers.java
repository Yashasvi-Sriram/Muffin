...
/**
 * doGetWithSession:  returns no followers
 * doPostWithSession: same as get
 */
@WebServlet("/muff/fetch/nofollowers")
public class FetchNoFollowers extends MuffEnsuredSessionServlet {
    ...
    protected void doGetWithSession(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ServletException, IOException {
        ...
        Optional<Integer> noFollowersOpt = muffDAO.getNoFollowers(muff.getId());
