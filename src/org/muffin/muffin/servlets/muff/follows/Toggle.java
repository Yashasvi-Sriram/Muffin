...
/**
 * doGetWithSession:  toggles follower follows followee
 * doPostWithSession: same as get
 */
@WebServlet("/muff/follows/toggle")
public class Toggle extends MuffEnsuredSessionServlet {
    ...
    protected void doGetWithSession(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ServletException, IOException {
        ...
        Optional<Boolean> doesFollows = muffDAO.toggleFollows(followerId, followeeId);
