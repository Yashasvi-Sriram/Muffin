        ...
        return (
            <div className="card review hoverable">
                <div className="card-content">
                    <div><h4>{this.props.muff.name} </h4><span className="pink-text">@{this.props.muff.handle}</span></div>
...
window.InfiniteMovieFeedApp = React.createClass({
    TYPES: {
        REVIEW: 0,
    },
